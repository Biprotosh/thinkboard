...
const NoteForm = ({ defaultValues, mutate, heading, submitLabel }: NoteFormProps) => {
    ...
    return (
        <div className="w-full max-w-lg p-6 mx-auto mt-16 bg-gradient-to-br from-orange-100 to-white rounded-2xl shadow-lg">
            ...
            >
                <form.Field
                    ...
                    validators={{
                        onChange: ({ value }) => {
                            ...
                            return success ? undefined :error.issues[0].message; 
                        }
                    }}
                    children={(field) => (
                        <div>
                ...
                <footer>
                    <button
                        type="submit"
                        className="w-full px-5 py-2 text-white font-medium bg-orange-400 rounded-lg shadow-md hover:bg-orange-500 transition"
                    >
                        {submitLabel}
                    </button>
                </footer>
